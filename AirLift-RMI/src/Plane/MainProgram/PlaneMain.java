...
public class PlaneMain {
    ...
    public static void main(String [] args){
       ...
       int regPortNum = Parameters.REGISTRY_PORT;
        ...
        try
        {
            planeInt = (PlaneInterface)UnicastRemoteObject.exportObject(plane, Parameters.DESTINATION_AIRPORT_PORT);
        }
        catch (RemoteException ex) {
            System.out.println("Plane stub generation exception: " + ex.getMessage () );
            ex.printStackTrace ();
            System.exit(1);
        }
        try
        ...
        System.out.println("Plane finished execution");
        ...
        { System.out.println ("Plane unregistration exception: " + e.getMessage ());
          e.printStackTrace ();
          System.exit (1);
        } catch (NotBoundException ex) {
         System.out.println ("Plane unregistration exception: " + ex.getMessage ());
          ex.printStackTrace ();
          System.exit (1);
        }
        System.out.println ("Plane object was unregistered!");
       ...
       System.out.println("Plane object was unexported successfully!");
